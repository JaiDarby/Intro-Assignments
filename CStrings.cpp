...
int main() {
	string UserSentence, UserWord;
	int NumPunc, NumVow, NumWords, length, One, Two, Three, Four, Five, Six, Seven, Eight, Nine, Ten, Eleven, Twelve, Thirteen, Fourteen, Fiffteen, Sixteen, Seventeen, Eighteen, Nineteen, Twenty, i, x, y;
	...
	for (i = 0; i < UserSentence.length(); i += 1){
		...
		if (){
			...
			cout << "The word: " << UserWord << " IS NOT a part of the sentence you entered."
		}
